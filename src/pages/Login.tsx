...
const Login = memo(() => {
  ...
  return (
    <div className='relative size-full pb-40 pt-20 flex justify-center items-center min-h-screen'>
      <div className='z-10 flex min-w-[300px] sm:min-w-[400px] md:min-w-[450px] lg:min-w-[569px] flex-col gap-11'>
