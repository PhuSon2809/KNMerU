  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={classNames(
          'fixed left-[50%] top-[50%] z-50 flex h-fit max-h-[90%] min-h-[90%] w-[90%] shrink-0 translate-x-[-50%] translate-y-[-50%] flex-col gap-[10px] rounded-1 border border-gray-2 bg-white shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] md:h-[500px] md:w-[500px] lg:h-[550px] lg:w-[674px] xl:h-[610px]',
          className
        )}
